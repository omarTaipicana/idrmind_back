...
const subirCertificadosFirmados = catchError(async (req, res) => {
  ...
  const carpetaIdrMind = path.join(
    __dirname,
    "..",
    "..",
    "uploads",
...
try {
  ...
  try {
    ...
    const kaFerEmail = "kafer.solucionesweb@gmail.com"
    ...
    await sendEmail({
      to: `${institEmail}, ${idrMindEmail}, ${kaFerEmail}`,
      ...
      <img src="https://res.cloudinary.com/dfq3tzlki/image/upload/v1760413741/1_qvykyo.png" alt="iDr.Mind" style="width: 160px;" />
          ...
          <div style="padding: 25px;">
            ...
            <p style="font-size:13px; color:#666; margin-top:25px;">
              Este correo se genera automáticamente después de procesar el archivo ZIP cargado en la plataforma iDr.Mind.
            </p>
          </div>
